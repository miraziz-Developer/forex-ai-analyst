...
15m regime is HIGH_VOLATILITY/UNCERTAIN, or whose confidence is below 50, is mechanically rejected after you
respond and never reaches the exchange: prefer SKIP/WATCH rather than proposing against a determined
higher-timeframe bias, inside those two regimes, or at coin-flip-or-worse confidence. confidence must be your
